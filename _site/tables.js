...
export const weapons = [
  {name:"Quarterstaff",dmg:"1d8",slots:2},{name:"Rapier",dmg:"1d6",slots:1},{name:"Dagger",dmg:"1d6",slots:1},{name:"Shortsword",dmg:"1d6",slots:1},{name:"Cudgel",dmg:"1d6",slots:1},{name:"Sickle",dmg:"1d6",slots:1},{name:"Spear",dmg:"1d8",slots:2},{name:"Longsword",dmg:"1d8",slots:2},{name:"Mace",dmg:"1d8",slots:2},{name:"Axe",dmg:"1d8",slots:2},{name:"Flail",dmg:"1d8",slots:2},{name:"Warhammer",dmg:"1d8",slots:2},{name:"Halberd",dmg:"1d10A",slots:3},{name:"Maul",dmg:"1d10A",slots:3},{name:"Greataxe",dmg:"1d10A",slots:3},{name:"Greatsword",dmg:"1d10A",slots:3},{name:"Sling",dmg:"1d4",slots:1},{name:"Hand Crossbow",dmg:"1d4",slots:1},{name:"Shortbow",dmg:"1d4",slots:1},{name:"Longbow",dmg:"1d6",slots:2},{name:"Crossbow",dmg:"1d6",slots:2},{name:"Warbow",dmg:"1d6",slots:2}
];
...
export const personalities = ["Addicted","Alluring","Aloof","Banal","Careful","Cheery","Childish","Chivalrous","Coarse","Compliant","Confident","Conformist","Conniving","Conservative","Corrupt","Courageous","Cultured","Cunning","Curious","Defective","Defiant","Delightful","Dependable","Despondent","Devoted","Dignified","Disciplined","Docile","Eccentric","Fanatical","Fickle","Focused","Foolish","Forthright","Generous","Glum","Greedy","Habitual","Helpful","Honest","Honourable","Hopeless","Humble","Idealistic","Inconsiderate","Indifferent","Insensitive","Insightful","Jovial","Kind","Lazy","Lethargic","Liberal","Likable","Lively","Logical","Loyal","Meek","Mindless","Miserly","Naive","Needy","Nefarious","Neglectful","Noble","Oblivious","Obnoxious","Optimistic","Passionate","Pessimistic","Pious","Pleasant","Pragmatic","Prying","Pushy","Rational","Reckless","Refined","Relaxed","Resilient","Revolting","Righteous","Romantic","Rude","Scholarly","Sensible","Serene","Shrewd","Sinful","Solemn","Stoic","Subtle","Suspicious","Tactless","Thoughtful","Touchy","Unconcerned","Uncouth","Uneducated","Unreasonable","Unseemly","Unsupportive","Vain","Valiant","Wasteful","Wicked","Wild","Wise"];
export const conversationInterests = ["Allies","Antagonist","Campaign","Character","Child","Community","Contacts","Current quest","Current scene","Dungeons","Enemy","Equipment","Experience","Fame","Family","Flaws","Friends","Future action","History","Knowledge","Last action","Last quest","Last scene","Magic","Parents","Power","Recent quest","Recent scene","Relics","Retainers","Rewards","Skills","Superiors","Treasure","Wealth","Weapons"];
export const equipmentTypes = ["Nothing","Basic travel","Basic combat","Travel & combat","Anything"];
export const competenceTypes = ["A liability","Average","Competent","Very capable","Exceptional"];
