// Dice.js - FORGE Dice Roller Module
// A comprehensive dice rolling system for tabletop gaming

// Import UI components
const { Card, CardHeader, CardTitle, CardContent } = window.ForgeUI;
    ...
    React.createElement(Card, null, 
      React.createElement(CardHeader, null, 
        React.createElement("div", {
          ...
          React.createElement(CardTitle, null, "FORGE Dice Roller")
        )
      ),
      React.createElement(CardContent, null, 
        React.createElement("div", {
          ...
          // Last Roll Result
          lastRoll && React.createElement("div", {
            key: "last-roll",
            ...
            React.createElement("div", {
              ...
              lastRoll.results.length > 1 && React.createElement("p", {
                key: "result-details",
          ...
          // History Section
          rollHistory.length > 0 && React.createElement("div", {
            key: "history-section",
            className: "p-4 border rounded-lg"
          }, [
            React.createElement("div", {
