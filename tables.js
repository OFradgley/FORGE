...
export const equipmentTypes = ["No equipment of their own","Equipped for basic travel","Equipped for basic combat","Equipped for travel & combat","Best equipment money can buy"];
export const competenceTypes = ["A liability (L0, ML5)","Average (L1, ML6)","Competent (L1, ML7)","Very capable (L2, ML8)","Exceptional (L3, ML9)"];
